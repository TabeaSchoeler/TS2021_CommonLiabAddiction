...
knitr::kable(gwasSumStast_sel, 
             format = "simple",
             aption = "Summary statistic files", "html") %>%
      kable_material_dark()
...
- in the next steps, multivariate LD score regression analysis is performed
- Genomic control was applied to all summary statistics showing evidence of uncontrolled confounding (LD score intercept > 1), by multiplying standard errors by the LD score intercept
