...
2.  [Pre-processing of summary statistic files](#pre)
3.  [Munging of statistic files](#munge)
4.  [Specification of the structural model](#strucModel)
5.  [Run the common liability GWA analysis](#gwaRun)
6.  [Processing the common liability GWA output](#gwaOutput)
